...
def main():  
    # Traing Workflow Utilization Prediction Model
    train_model()

    # Forecast using Workflow Utilization Prediction Model
...
def forecast_using_model():
    try:
        ...
        # Read Excel File, Sort by Date in ascending order and Group it Workflow  Utilization by Date
        ...
        # Load the Workflow Utilization Prediction Model from file which has the trained model
